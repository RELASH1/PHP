        ...
        <div class="col-12 col-lg-9 col-xl-7">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Ajouter un etudiant premiere annee informatique</h3>
              <form action="infoBD.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="femaleGender" value="Femme" checked />
                      <label class="form-check-label" for="femaleGender">Femme</label>
                    </div>

                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="maleGender" value="Homme" />
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4 pb-2">
                    ...
                    <select class="select form-control-lg" name="classe">
                      ...
                      <option value="TI 1.1">TI 1.1</option>
                      <option value="TI 1.2">TI 1.2</option>
                      <option value="TI 1.3">TI 1.3</option>
                    </select>
