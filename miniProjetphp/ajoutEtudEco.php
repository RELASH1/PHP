      ...
      <div class="col-12 col-lg-9 col-xl-7">
        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
          <div class="card-body p-4 p-md-5">
            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Ajouter un etudiant premiere annee Economie gestion</h3>
            <form action="ecoBD.php" method="POST">
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 pb-2">
                  ...
                  <select class="select form-control-lg" name="classe">
                    ...
                    <option value="EG 1.1">EG 1.1</option>
                    <option value="EG 1.2">EG 1.2</option>
                    <option value="EG 1.3">EG 1.3</option>
                  </select>
